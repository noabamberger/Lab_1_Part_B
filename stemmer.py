...
Classic Porter (1980) algorithm. Stemming the BM25 tokenizer lets a query word
match its morphological variants in a page ("negotiator"/"negotiations" ->
"negoti", "improved"/"improvement" -> "improv"), which raised both lexical
